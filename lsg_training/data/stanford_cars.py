...
from .imagelist import ImageList, ImageList_IDX
from ._util import *
...
class StanfordCars(ImageList):
    ...
    image_list = {
        ...
        "train80": "image_list/train_80.txt",
        "train65": "image_list/train_65.txt",
...
class StanfordCars_IDX(ImageList_IDX):
    """`The Stanford Cars <https://ai.stanford.edu/~jkrause/cars/car_dataset.html>`_ Dataset.
    ...
    def __init__(self, root: str, split: str, label_ratio: Optional[int] =100, download: Optional[bool] = False, **kwargs):
        ...
        super(StanfordCars_IDX, self).__init__(root, StanfordCars_IDX.CLASSES, data_list_file=data_list_file, **kwargs)
